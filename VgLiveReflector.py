"""
Export raw Parquet rows for requests that belong to unmapped (Other) channels.
...
START_DATE = datetime(2026, 5, 24)    # ← change as needed
END_DATE   = datetime(2026, 5, 25)    # ← change as needed

OUTPUT_CSV = "unmapped_raw_rows.csv"
MAX_ROWS   = 10000   # limit rows to avoid memory issues (set to 0 for unlimited)
...
def main():
    ...
    # Build mapping table as a SQL VALUES clause
