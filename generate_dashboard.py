...
# ╚══════════════════════════════════════════════════════════════╝
XLSX_PATH = Path(r"D:\Veto Logs Backup\veto Stream logs\lake\overview_report.xlsx")   # ← your Excel
HTML_OUT  = Path(r"D:\Veto Logs Backup\veto Stream logs\lake\overview_dashboard.html")  # ← output
# ════════════════════════════════════════════════════════════════
