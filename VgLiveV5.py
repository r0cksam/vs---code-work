...
def calculate_watch_hours(file_path):
    ...
    columns_to_load = ['reqPath', 'cliIP', 'statusCode']
    ...
    try:
        ...
        # Example: 'v1/vglive-sk-274906/main_1.ts' -> 'vglive-sk-274906'
        # Example: 'vglive-sk-238731/xyz.ts' -> 'vglive-sk-238731'
        print("Extracting Stream IDs and mapping channel names...")
        
        # This handles paths with or without 'v1/' prefixes dynamically
        ...
        # 3. CRUCIAL FIX: Deduplicate rapid retry/re-buffered requests
        # Group by User, Channel, and the exact .ts path, dropping redundant delivery attempts
