...
class AppConfig:
    ...
    disk_cache_enabled: bool = os.getenv("PDASH_DISK_CACHE", "1") not in {"0", "false", "False"}
    disk_cache_max_age_seconds: int = int(os.getenv("PDASH_DISK_CACHE_MAX_AGE_SECONDS", "604800"))
