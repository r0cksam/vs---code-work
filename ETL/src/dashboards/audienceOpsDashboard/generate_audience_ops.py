...
def build_data(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "data": {
            ...
            "ua_platform_daily": records(ua_playtime["platform"]),
            "ua_os_daily_schema": compact_schema(ua_playtime["os"]),
            "ua_os_daily": compact_records(ua_playtime["os"]),
            "ua_brand_daily_schema": compact_schema(ua_playtime["brand"]),
            "ua_brand_daily": compact_records(ua_playtime["brand"]),
            "ua_model_daily_schema": compact_schema(ua_playtime["model"]),
            "ua_model_daily": compact_records(ua_playtime["model"]),
